...
# Initialise
fhi::DashboardInitialiseOpinionated("ANALYSIS",STUB=tmpdir, PACKAGE_DIR=pkg)
...
[fhi::DashboardMsg](../reference/DashboardMsg.html) is a stylised version of `message`, `warning`, and `stop`. It prints the requested message with a traceback of system calls
